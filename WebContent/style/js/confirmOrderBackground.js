$(document).ready(function () {
    ...
    // window.alert("confirmOrderBackground.js");
    ...
    if (loginStatus == true) {
        ...
        function getReceivers(username) {
            $.get("../../GetReceiverInfo.action", {
                ...
                console.log("confirmOrderBackground.js#####getReceivers()###$.get()");
            })
        }
        ...
        $(".confirm").click(function () {
            ...
            $.get("../../SubmitOrder.action", {
                ...
                if (result.match("false")) {
                    ...
                    window.location.replace("http://localhost:8080/pages/profiles/user.jsp");
