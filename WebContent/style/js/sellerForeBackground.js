$(document).ready(function () {
     // console.log("sellerForeBackground.js    %d  %f \n",22,3.1415926);
...
////////////////////////////////////////////////////////////////////
    ...
    function getFoodsBrief(pageContent, page) {
        ...
        console.log("getFoodsBrief(pageContent, page)\n");
        console.log("pageContent    %s\npage   %d",pageContent, page);
        ...
        $.get('../../GetFoodsBrief.action', {
            ...
            $.each(foods, function (i, food) {
                ...
                console.log("\n");
                console.log("$\(\".root .food:last\"\)		%s",$(".root .food:last").html());
                console.log("\n");
...
//////////////////////////////////////////////
    ...
    function createFoodBrief() {
        var newfood = '<div class="food col-xs-6 col-sm-4 col-md-3" style="display:none;"><div class="thumbnail"><img style="height:110px;width:120px;" src="../../style/images/foods/default.jpg" alt="通用的占位符缩略图"><div class="caption">' +
            ...
            '<button class="btn btn-success cd-add-to-cart " role="button">加入购物车</button></div></div></div>';
...
///////////////////////////////////////////////////////////
    ...
    $(".root").delegate(".cd-add-to-cart", "click", function () {
        console.log("sellerForeBackground.js $(\".root\").delegate(\".cd-add-to-cart\", \"click\",   \n");
