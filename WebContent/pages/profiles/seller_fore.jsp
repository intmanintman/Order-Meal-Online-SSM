<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<script type="text/javascript ">
        ...
        console.log("\n");
//        console.log("sessionStorage.getItem(userRegistrationID)		%s",sessionStorage.getItem(userRegistrationID).toString());
//        console.log("sessionStorage.getItem(sessionScope.userLoginStatus)		%s",sessionStorage.getItem(sessionScope.userLoginStatus));
//        console.log("sessionStorage.getItem(sessionScope.username)		%s",sessionStorage.getItem(sessionScope.username));
//        console.log("sessionStorage.getItem(sessionScope.userRegistrationID)		%s",sessionStorage.getItem(sessionScope.userRegistrationID));
        console.log("\n");
